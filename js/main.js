...
function enterKey(e) {
    ...
    if (pw) {
        ...
        if (e.keyCode == 13) {
            ...
            git = commands.length;
            addLine("guest@robertterminal:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
    switch (cmd.toLowerCase()) {
        ...
        case "whoami":
            ...
            break;
        case "bookshelf":
            addLine("opening goodreads...", "color2", 80);
            newTab(bookshelf);
            break;
        case "sudo":
        ...
        case "history":
            ...
            break;
        case "email":
            addLine('Opening mailto:<a href="mailto:robert.sheng@vanderbilt.edu">robert.sheng@vanderbilt.edu</a>...', "color2", 80);
            newTab(email);
            break;
        case "clear":
            setTimeout(function () {
